...
config.bind(',wl', 'config-cycle content.user_stylesheets ~/.cache/wal/colors.css ""')
config.bind(',wp', 'config-cycle content.user_stylesheets ~/.cache/wal/everything.css ""')
# config.set("fileselect.handler", "external")

# config.set("fileselect.single_file.command", ['st', '-e', 'emacsclient -c --eval "(dired \\"{}\\")"'])
# config.set("fileselect.multiple_files.command", ['st', '-e','emacsclient -c --eval "(dired \\"{}\\" )"'])
config.set("fileselect.handler", "external")
...
# config.set("fileselect.multiple_files.command", ['alacritty', '-e', 'ranger', '--choose-files', '{}'])
